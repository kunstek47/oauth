...
function App() {
  const [hiddenText, setHiddenText] = useState(
    "Currently Hidden! Please log in to reveal text!"
  ); //will hold value of hidden text
  ...
  return (
    <>
      <div className={"center"}>
        <h1>
          OAuth/OAuth2: pregled, primjeri, ranjivosti, alternative, studije
          slučaja{" "}
        </h1>
      </div>
      <div className={"center"}>
      ...
      <div className={"center"}>
        <h3>
          Izradili: Ivan Blažek, Iva Kozmač, Antonio Kunštek, Helena Potočki,
          Žan Žlender
        </h3>
      </div>
      <br></br>
